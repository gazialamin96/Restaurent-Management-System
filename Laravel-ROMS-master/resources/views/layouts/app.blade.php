...
<section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
        <div class="navbar-header aside-md">
            ...
            <a href="#" class="navbar-brand" style="color: #fb6b5b; font-weight: 200" data-toggle="fullscreen">Food <span style="font-size: 40px; color: rgb(101, 189, 119); font-weight: 900">King</span></a>
            <a class="btn btn-link visible-xs" data-toggle="dropdown" data-target=".nav-user">
                <i class="fa fa-cog"></i>
            </a>
        </div>
        <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
            <li class="hidden-xs"><a href="#" class="dropdown-toggle"> <b>Food King</b></a></li>
            <li class="dropdown">
                            ...
                            <section class="dropdown-menu on aside-md m-l-n">
                                <section class="panel bg-white">
                                    ...
                                    <div class="panel-body animated fadeInRight">
                                        <p class="text-sm">Copyright © {{ date("Y") }} <b>Food King</b></p>
                                        <p>BY <strong><span style="color: green">GAZI</span><span style="color:red"> AL-AMIN</span></strong></p>
                                    </div>
                                </section>
                            </section>
                        </div>
